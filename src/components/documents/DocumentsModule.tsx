  ...
  const handleDownloadDocument = async (docRecord: any) => {
    try {
      ...
      if (docRecord.document_type === 'consentimiento_datos_biometricos') {
        tempDiv.innerHTML = `
          <div style="width: 100%; max-width: 794px; margin: 0 auto; font-family: Arial, sans-serif; background: white; color: black; padding: 20px; box-sizing: border-box;">
            <h1 style="text-align: center; font-size: 18px; font-weight: bold; text-transform: uppercase; margin-bottom: 20px; line-height: 1.3;">
              CONSTANCIA DE CONSENTIMIENTO PARA USO DE CÁMARAS DE VIGILANCIA Y DATOS BIOMÉTRICOS
            </h1>
            <p style="margin-bottom: 12px; font-size: 14px;"><strong>Fecha:</strong> ${formattedDate}</p>
            <p style="text-align: justify; line-height: 1.5; margin-bottom: 16px; font-size: 13px;">
            ...
            <h2 style="font-size: 16px; font-weight: bold; margin-top: 20px; margin-bottom: 12px;">1. Cámaras de Vigilancia</h2>
            <p style="text-align: justify; line-height: 1.5; margin-bottom: 12px; font-size: 13px;">
            ...
            <ul style="margin-left: 25px; margin-bottom: 16px; padding-left: 0;">
              <li style="text-align: justify; line-height: 1.5; margin-bottom: 6px; font-size: 13px;">
                Las cámaras se encuentran ubicadas en espacios comunes y áreas de trabajo, sin invadir espacios privados.
              </li>
              <li style="text-align: justify; line-height: 1.5; font-size: 13px;">
            ...
            <h2 style="font-size: 16px; font-weight: bold; margin-top: 20px; margin-bottom: 12px;">2. Datos Biométricos – Registro de Huella Digital</h2>
            <p style="text-align: justify; line-height: 1.5; margin-bottom: 12px; font-size: 13px;">
            ...
            <h2 style="font-size: 16px; font-weight: bold; margin-top: 20px; margin-bottom: 12px;">3. Derechos del Trabajador/a</h2>
            <p style="text-align: justify; line-height: 1.5; margin-bottom: 8px; font-size: 13px;">El/la trabajador/a reconoce que:</p>
            <ul style="margin-left: 25px; margin-bottom: 20px; padding-left: 0;">
              <li style="text-align: justify; line-height: 1.5; margin-bottom: 6px; font-size: 13px;">
            ...
            <div style="margin-top: 40px;">
              <div style="margin-bottom: 30px;">
                <h3 style="font-size: 14px; font-weight: bold; margin-bottom: 16px;">Firma del Trabajador/a</h3>
                <p style="margin-bottom: 12px; font-size: 13px;">Nombre y Apellido: _________________________________</p>
                <p style="font-size: 13px;">DNI: _________________________________</p>
              </div>
              <div>
                <h3 style="font-size: 14px; font-weight: bold; margin-bottom: 16px;">Firma de la Empresa</h3>
                <p style="margin-bottom: 12px; font-size: 13px;">Representante: _________________________________</p>
                <p style="font-size: 13px;">Cargo: _________________________________</p>
              </div>
            </div>
          </div>
        `;
        ...
        tempDiv.innerHTML = `
          <div style="width: 100%; max-width: 794px; margin: 0 auto; font-family: Arial, sans-serif; background: white; color: black; padding: 20px; box-sizing: border-box;">
            <h1 style="text-align: center; font-size: 20px; font-weight: bold; text-transform: uppercase; margin-bottom: 6px; line-height: 1.2;">
              REGLAMENTO INTERNO
            </h1>
            <h2 style="text-align: center; font-size: 18px; font-weight: bold; text-transform: uppercase; margin-bottom: 20px;">
              AVÍCOLA LA PALOMA
            </h2>
            <p style="margin-bottom: 6px; font-size: 13px;"><strong>Fecha:</strong> ${formattedDate}</p>
            <p style="margin-bottom: 16px; font-size: 13px;"><strong>Nombre del empleado:</strong> ${employeeName}</p>
            <p style="text-align: justify; line-height: 1.4; margin-bottom: 16px; font-size: 12px;">
            ...
            <h3 style="font-size: 14px; font-weight: bold; margin-top: 16px; margin-bottom: 10px;">1. Obligaciones y deberes de los empleados</h3>
            <ul style="margin-left: 20px; margin-bottom: 16px; padding-left: 0; font-size: 12px;">
              <li style="text-align: justify; line-height: 1.4; margin-bottom: 4px;">
            ...
            <h3 style="font-size: 14px; font-weight: bold; margin-top: 16px; margin-bottom: 10px;">2. Derechos de los empleados</h3>
            <ul style="margin-left: 20px; margin-bottom: 16px; padding-left: 0; font-size: 12px;">
              <li style="text-align: justify; line-height: 1.4; margin-bottom: 4px;">
            ...
            <h3 style="font-size: 14px; font-weight: bold; margin-top: 16px; margin-bottom: 10px;">3. Normas de trabajo dentro de la granja</h3>
            <ul style="margin-left: 20px; margin-bottom: 16px; padding-left: 0; font-size: 12px;">
              <li style="text-align: justify; line-height: 1.4; margin-bottom: 4px;">
            ...
            <h3 style="font-size: 14px; font-weight: bold; margin-top: 16px; margin-bottom: 10px;">4. Prohibiciones</h3>
            <ul style="margin-left: 20px; margin-bottom: 16px; padding-left: 0; font-size: 12px;">
              <li style="text-align: justify; line-height: 1.4; margin-bottom: 4px;">
            ...
            <h3 style="font-size: 14px; font-weight: bold; margin-top: 16px; margin-bottom: 10px;">5. Certificados y ausencias</h3>
            <ul style="margin-left: 20px; margin-bottom: 16px; padding-left: 0; font-size: 12px;">
              <li style="text-align: justify; line-height: 1.4; margin-bottom: 4px;">
            ...
            <h3 style="font-size: 14px; font-weight: bold; margin-top: 16px; margin-bottom: 10px;">6. Sanciones</h3>
            <ul style="margin-left: 20px; margin-bottom: 16px; padding-left: 0; font-size: 12px;">
              <li style="text-align: justify; line-height: 1.4; margin-bottom: 4px;">
            ...
            <p style="text-align: justify; line-height: 1.4; margin-bottom: 20px; font-size: 12px;">
            ...
            <div style="margin-top: 30px;">
              <p style="margin-bottom: 20px; font-size: 13px;"><strong>Firma Empleado</strong></p>
              <p style="font-size: 13px;">Aclaración: _________________________________</p>
            </div>
          </div>
        `;
      }
