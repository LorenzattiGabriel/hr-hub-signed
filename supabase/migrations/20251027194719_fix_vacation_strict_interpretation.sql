-- Fix vacation days calculation to use strict interpretation of labor law
-- "More than 5 years" means >= 5 complete years, not <= 5
-- This ensures employees with exactly 5 years receive 21 days, not 14
...
BEGIN
  ...
  -- INTERPRETACIÓN ESTRICTA: "Más de 5 años" = >= 5 años completos
  CASE 
    WHEN antiguedad_anios < 0 THEN RETURN 0;    -- Fecha futura
    WHEN antiguedad_anios < 5 THEN RETURN 14;   -- Más de 6 meses y hasta 5 años: 14 días corridos
    WHEN antiguedad_anios < 10 THEN RETURN 21;  -- Más de 5 años y hasta 10 años: 21 días corridos  
    WHEN antiguedad_anios < 20 THEN RETURN 28;  -- Más de 10 años y hasta 20 años: 28 días corridos
