            ...
            <div>
              ...
              <Select value={formData.cargo} onValueChange={(value) => handleInputChange("cargo", value)}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="responsable-stock">Responsable de stock</SelectItem>
                  <SelectItem value="administrativo">Administrativo</SelectItem>
                  <SelectItem value="vendedor-iluminacion">Vendedor iluminación</SelectItem>
                  <SelectItem value="repartidor">Repartidor</SelectItem>
                  <SelectItem value="responsable-redes">Responsable de redes</SelectItem>
                  <SelectItem value="responsable-ecommerce">Responsable de ecommerce</SelectItem>
